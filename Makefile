...
oracle-integration-sandbox: 
	cd ./oracle-integration; cargo concordium build -e --out oracle_integration.wasm.v1
...
build-all-sandbox: build-contracts staking-bank-sandbox oracle-integration-sandbox

build-all: build-contracts staking-bank-production staking-bank-sandbox staking-bank-development oracle-integration-production oracle-integration-development oracle-integration-sandbox

test-all:
	cd registry; cargo concordium test; cd ../staking-bank; cargo concordium test -- --features development; cd ../umbrella-feeds; cargo concordium test; cd ../oracle-integration; cargo concordium test;
