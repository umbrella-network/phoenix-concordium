...
#[receive(contract = "umbrella_feeds", name = "ONE", return_value = "U256Wrapper")]
...
#[receive(contract = "umbrella_feeds", name = "view", return_value = "State")]
...
/// View function that returns the balance of an validator
#[receive(contract = "umbrella_feeds", name = "register")]
...
/// View function that returns the balance of an validator
#[receive(contract = "umbrella_feeds", name = "_addresses", return_value="Vec<AccountAddress>")]
...
/// View function that returns the balance of an validator
#[receive(contract = "umbrella_feeds", name = "_isValidator", parameter="AccountAddress", return_value="bool")]
